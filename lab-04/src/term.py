...
'''
DerivedTerm = TmLetRec
ComplexTerm = TmApp | TmAbs | TmTrue | TmFalse | TmIf | TmZero | TmUnit | TmIsZero | TmSucc | TmPred | TmLet | TmFix
Term = TmVar | ComplexTerm
UnexpandedTerm = Term | DerivedTerm
NamedTerm = TmNamedVar | ComplexTerm
